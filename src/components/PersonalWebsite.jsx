      ...
      <div className="gothic-header">
        <div className="lightning-group-left">
          <img
            src={lightningGif}
            alt="lightning"
            className="header-lightning header-lightning-left"
          />
          <img
            src={lightning2Gif}
            alt="lightning"
        ...
        <div className="lightning-group-right">
          <img
            src={lightning2Gif}
            alt="lightning"
            className="header-lightning header-lightning-right"
          />
          <img
            src={lightningGif}
            alt="lightning"
            ...
            <div className="gothic-section">
              ...
              <div className="section-content">
                ...
                <p className="gothic-text">
                  I'm Alex, a Web Developer. If you want to talk about creative
                  projects,{" "}
          ...
          <>
            <div className="gothic-section">
              ...
              <div className="section-content">
                ...
                <p className="gothic-text">
                  When I'm not coding, I'm passionate about music! I make music,
                  play in a band, and do music production.
                </p>
                    ...
                    <div className="band-info">
                      <div className="bandcamp-embeds">
                        <div className="bandcamp-embed-wrapper">
                          ...
                          >
                            <a href="https://voidnothingnessdoom.bandcamp.com/album/ride-out-witching-hour">
                              Ride Out / Witching Hour by Void &amp; The
                              Nothingness
                            </a>
                          </iframe>
                        </div>
                        <div className="bandcamp-embed-wrapper">
                          ...
                          >
                            <a href="https://voidnothingnessdoom.bandcamp.com/album/void-the-nothingness">
                              Void &amp; The Nothingness by Void &amp; The
                              Nothingness
                            </a>
                          </iframe>
                        </div>
